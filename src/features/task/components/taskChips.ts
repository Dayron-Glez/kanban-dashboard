...
> = {
  ...
  p1: {
    ...
    borderClassName:
      "border-orange-200 border-l-orange-400 dark:border-orange-900 dark:border-l-orange-600",
  ...
  p2: {
    ...
    borderClassName:
      "border-blue-200 border-l-blue-400 dark:border-blue-900 dark:border-l-blue-600",
...
export const SIZE_CONFIG: Record<TaskSize, { label: string; className: string }> = {
  ...
  l: {
    label: "L",
    className: "bg-violet-50 text-violet-600 dark:bg-violet-950/40 dark:text-violet-400",
  },
  xl: {
    label: "XL",
    className: "bg-orange-50 text-orange-500 dark:bg-orange-950/40 dark:text-orange-400",
  },
}

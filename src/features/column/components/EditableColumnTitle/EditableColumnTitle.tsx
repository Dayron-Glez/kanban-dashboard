...
export function EditableColumnTitle({ title, onSave, onCancel }: EditableColumnTitleProps) {
  ...
  return (
    <Field data-invalid={!!error}>
      <Input
        {...form.register("title")}
        className="focus-visible:ring-primary h-9 flex-1 focus-visible:ring-1"
